    ...
    return (
        ...
        <div className={`dashboard-layout ${theme}`}>
            ...
            <div className="mobile-header">
                <Link to="/dashboard" className="sidebar-logo" style={{ marginBottom: 0, textDecoration: 'none' }}>SaaS App</Link>
                <button className="btn-outline-ui" onClick={toggleSidebar} style={{ color: 'var(--text-primary)', borderColor: 'var(--border-color)', padding: '8px 12px' }}>
            ...
            <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
                <Link to="/dashboard" className="sidebar-logo" style={{ textDecoration: 'none' }}>SaaS App</Link>
